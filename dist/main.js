...
/* harmony import */ var _styles_stylus_stylus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./styles/stylus.stylus */ "./styles/stylus.stylus");
/* harmony import */ var _styles_stylus_stylus__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_styles_stylus_stylus__WEBPACK_IMPORTED_MODULE_7__);
...
jquery__WEBPACK_IMPORTED_MODULE_6__('pre').html(post.toString()); // console.log("post", post.toString());
...
var unused = ""; // class properties, need babel plugin (@babel/plugin-proposal-class-properties)
